...
- Gate B evidence：[`../03_Evolution/02_Experiments/02_Pilots/gate-b-minimal-human-task-walkthrough-2026-09-02.zh-CN.md`](/03_Evolution/02_Experiments/02_Pilots/gate-b-minimal-human-task-walkthrough-2026-09-02.zh-CN.md)
...
Gate B 的最小执行证据见 [`../03_Evolution/02_Experiments/02_Pilots/gate-b-minimal-human-task-walkthrough-2026-09-02.zh-CN.md`](/03_Evolution/02_Experiments/02_Pilots/gate-b-minimal-human-task-walkthrough-2026-09-02.zh-CN.md)。更大规模 usability research 不是 v0.1 Foundation 的毕业前置条件，除非后续 P0 evidence 证明当前核心任务仍存在结构性阻塞。
