...
- 验收：按 [`human-interface-minimal-compare-contract.zh-CN.md`](/docs/02_System/02_Interface/03_Contracts/human-interface-minimal-compare-contract.zh-CN.md) 检查代表候选能否在保留上下文、缺失语义和来源边界的前提下形成可扫描差异。
