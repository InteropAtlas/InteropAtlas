...
STYLE = """
body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:980px;margin:0 auto;padding:32px 20px;line-height:1.65;color:#202124;background:#fff}
a{color:#0969da;text-decoration:none}a:hover{text-decoration:underline}
nav{margin-bottom:28px;padding-bottom:14px;border-bottom:1px solid #d0d7de}
...
h1,h2{line-height:1.25}h2{margin-top:30px}.meta{color:#57606a}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:16px}.card{border:1px solid #d0d7de;border-radius:8px;padding:16px}
"""


def page_shell(title: str, body: str, prefix: str = "") -> str:
    return f"""<!doctype html>
<html lang=\"zh-CN\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><title>{html.escape(title)} · InteropAtlas</title><style>{STYLE}</style></head>
<body><nav><a href=\"{prefix}index.html\"><strong>InteropAtlas</strong></a> · 人类可读实验站</nav>{body}</body></html>"""
